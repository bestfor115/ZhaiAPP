 ...
 */
 ...
 var login = React.createClass({
 	...
 	renderRegister:function(){
 		...
 		return (
 			<View style={[styles.container,CSS.containerStyle]} >
 			...
 			<TouchableHighlight style={[styles.btn,styles.marginTop30]} underlayColor='#0057a84a' onPress={this.register}>
